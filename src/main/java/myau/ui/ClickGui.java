...
public class ClickGui extends GuiScreen {
    ...
    public ClickGui() {
        ...
        movementModules.add(Myau.moduleManager.getModule(SprintReset.class));
        ...
        movementModules.add(Myau.moduleManager.getModule(BridgeAssist.class));
        ...
        movementModules.add(Myau.moduleManager.getModule(KnockbackDelay.class));
        ...
        playerModules.add(Myau.moduleManager.getModule(AutoRecraft.class));
        ...
        playerModules.add(Myau.moduleManager.getModule(ThrowPot.class));
